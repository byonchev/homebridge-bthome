...
### Changed
- Reset noble after stopping to ensure adapter is back to original state

## [2.1.0] - 2026-01-25

### Added
- Introduce auto recovery if scanner stops discovering devices after a while
...
- Correct value parsing for temperature data with 0.35 precision
...
[2.1.1]: https://github.com/byonchev/homebridge-bthome/compare/v2.1.0...v2.1.1
